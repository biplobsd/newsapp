...
mixin _$TopHeadlines {
  ...
  /// Serializes this TopHeadlines to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of TopHeadlines
...
class _$TopHeadlinesImpl implements _TopHeadlines {
  ...
  @override
  String toString() {
    return 'TopHeadlines(status: $status, totalResults: $totalResults, articles: $articles, code: $code, message: $message)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status, totalResults,
      const DeepCollectionEquality().hash(_articles), code, message);
...
abstract class _TopHeadlines implements TopHeadlines {
  const factory _TopHeadlines(
      ...
      final List<Article>? articles,
      final String? code,
      final String? message}) = _$TopHeadlinesImpl;
